<template>
    <div class="rank-body">
        <div class="rank-tab-wrap">
            <ul class="rank-tab">
                <router-link v-for="item in RankTabWrap" active-class="active" :to="{ path: '/ranking/all/' +item.rid+ '/'+$route.params.rankselect+'/'+$route.params.rankselect2 }" tag="li" :key="item.id">
                    {{ item.name }}
                </router-link>
            </ul>
