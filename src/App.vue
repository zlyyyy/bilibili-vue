...
.app-header .search .search-keyword {
    float: left;
    width: 200px;
    color: #222;
    font-size: 12px;
...
.app-header .search button.search-submit {
    display: block;
    position: absolute;
    right: 0;
    width: 48px;
...
.app-header .bilibili-suggest .b-line {
    border-top: 1px solid #e5e9ef;
    position: relative;
    height: 10px;
    margin: 10px 10px 0;
}
.app-header .bilibili-suggest .b-line p {
    margin-top: -10px;
    text-align: center;
}
.app-header .bilibili-suggest .b-line span {
    display: inline-block;
    padding: 0 10px;
    height: 18px;
    text-align: center;
...
.app-header .bilibili-suggest .suggest-item {
    padding: 6px 10px;
    cursor: pointer;
...
.app-header .bilibili-suggest .suggest-item a {
    color: #222;
    display: block;
    max-width: 200px;
    overflow: hidden;
...
.app-header .bilibili-suggest .cancel {
    position: absolute;
    right: 10px;
    top: 0;
    width: 38px;
...
.app-header .search .link-ranking {
    position: absolute;
    left: 2px;
    top: 2px;
    height: 32px;
...
.app-header .search .link-ranking span {
    padding-left: 26px;
    color: #f25d8e;
    display: inline-block;
    background: url(assets/icons.png) -659px -655px no-repeat;
}
.app-header .head-banner .head-content .head-logo {
    position: absolute;
    width: 220px;
    height: 105px;
    left: 24px;
...
.app-footer .footer-cnt {
    width: 980px;
    margin: 0 auto;
    overflow: hidden;
}
.app-footer .boston-postcards {
    list-style: none;
    margin: 0 auto;
    display: flex;
    margin-bottom: 30px;
}
.app-footer .boston-postcards li {
    flex: 1;
    text-align: left;
    list-style: none;
    height: 112px;
...
.app-footer .boston-postcards li:first-child {
    border-left: 0;
    padding: 0 20px 0 0;
}
.app-footer .boston-postcards li:last-child {
    padding: 0 20px 0 25px;
}
.app-footer .boston-postcards li .tips {
    margin-bottom: 22px;
    color: #99a2aa;
}
.app-footer .boston-postcards li .cards {
    float: left;
    width: 33%;
    position: relative;
    margin-bottom: 16px;
...
.app-footer .block div {
    position: relative;
    width: 82px;
    height: 80px;
    float: left;
}
.app-footer .block .pic {
    position: relative;
    margin-left: 11px;
    width: 60px;
    height: 60px;
...
.app-footer .block .qrcode-box-wrp {
    width: 130px;
    height: 130px;
    background: #fff;
    margin-top: -146px;
